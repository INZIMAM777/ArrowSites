...
import { 
  FiHome, FiDollarSign, FiMapPin, FiLayers, 
  FiCheckCircle, FiXCircle, FiArrowRight, 
  FiArrowLeft, FiPlus, FiCheck 
} from 'react-icons/fi';
import { useFirebase } from '../context/FirebaseContext';

export const AddPropr = () => {
    const { handleListing, getLists, presentId, properties: existingProperties } = useFirebase();
    presentId()// after calling this u get all present ids and store this id some were state or variable and use that variable to check the  generate new id
    ...
    // Flatten all property types for the dropdown
    const allPropertyTypes = Object.values(propertyCategories).flat();
    ...
    useEffect(() => {
        ...
        // Extract existing IDs from properties
        // if (existingProperties && existingProperties.length > 0) {
        //     const ids = existingProperties.map(property => property.id);
        //     setExistingIds(ids);
        // }
    ...
    // verify the present id and then generate the new id
    ...
    return (
        <div style={styles.container}>
            <h2 style={styles.heading}>
                <FiHome size={24} />
                {step === 5 ? 'Review Your Property' : 'Add New Property'}
            </h2>
