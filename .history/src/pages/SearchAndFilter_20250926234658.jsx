...
export const SearchAndFilter = ({
    ...
    button: {
     ...
     primaryButtonHover: {
        background: isDarkMode 
            ? 'linear-gradient(135deg, #2563eb, #1e40af)'  // Darker blue for dark mode
            : 'linear-gradient(135deg, #7c3aed, #5b21b6)', // Purple for light mode
        color: '#fff',
        transform: 'translateY(-2px)',
        boxShadow: isDarkMode 
            ? '0 6px 16px rgba(37, 99, 235, 0.35)'  // Blue shadow for dark mode
            : '0 6px 16px rgba(124, 58, 237, 0.35)' // Purple shadow for light mode
    },
    secondaryButton: {
  ...
  const buttonHoverStyles = {
    ...
    secondaryButtonHover: {
        ...
        color: theme.text.primary,
        borderColor: isDarkMode ? theme.border.accent : '#7c3aed'
    },
    tertiaryButtonHover: {
        backgroundColor: isDarkMode 
            ? `${theme.text.accent}15` 
            : 'rgba(124, 58, 237, 0.1)'
    },
    clearButtonHover: {
        color: theme.text.primary,
