...
export const DisplayCards = () => {
  ...
  const [debouncedSearch, setDebouncedSearch] = useState(""); // 👈 typing delay
  ...
  useEffect(() => {
    ...
    setDebouncedSearch(urlSearch); // also sync
  }, [searchParams]);
  ...
  useEffect(() => {
    applySearch(properties, debouncedSearch);
  ...
  // 🔹 Triggered when typing or clicking Search button
  const handleSearch = (term) => {
    ...
    // 🚀 Apply instantly on button click
    applySearch(properties, term);
  };
