...
export const DisplayCards = () => {
    ...
    const firebase = useFirebase();
      ...
      const { handleListing } = useFirebase();

  const handleAddProperties = async () => {
    try {
      await handleListing();
      console.log('Properties added successfully!');
      // You might want to refresh the properties list after adding
      // await getLists();
    } catch (error) {
    ...
    return (
        <>
            ...
            <button onClick={handleAddProperties} className="bg-blue-500 text-white px-4 py-2 rounded">
