...
export const AddPropr = () => {
    ...
    presentId()// after calling this u get all present ids and store this id some were state or variable and use that variable to check the last id of perticular type and then generate new id
