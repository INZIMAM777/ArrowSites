...
export const About = () => {
  ...
  const styles = {
    ...
    section: { display: "flex", alignItems: "center", justifyContent: "space-between", maxWidth: "1200px", margin: "4rem auto", padding: "0 2rem", flexWrap: "wrap" },
    sectionContent: { flex: "1 1 50%", minWidth: "300px", padding: "2rem" },
    sectionTitle: { fontSize: "clamp(2rem, 4vw, 2.5rem)", color: theme.text.accent, marginBottom: "1.5rem", fontFamily: "'Gilroy', 'Montserrat', sans-serif" },
    sectionText: { fontSize: "1.1rem", lineHeight: "1.6", color: theme.text.primary, marginBottom: "1.5rem" },
    sectionImage: { flex: "1 1 40%", minWidth: "300px", height: "400px", backgroundImage: "url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80')", backgroundSize: "cover", backgroundPosition: "center", borderRadius: "16px", boxShadow: "0 20px 40px rgba(0,0,0,0.1)" },
    ...
    testimonialAuthorImage: { width: "50px", height: "50px", borderRadius: "50%", backgroundColor: theme.background.tertiary, marginRight: "1rem", backgroundSize: "cover", backgroundPosition: "center" },
    testimonialAuthorName: { color: theme.text.accent, marginBottom: "0.2rem", fontFamily: "'Gilroy', 'Montserrat', sans-serif" },
    ...
    ctaTitle: { fontSize: "clamp(2rem, 4vw, 2.5rem)", marginBottom: "1.5rem", fontFamily: "'Gilroy', 'Montserrat', sans-serif" },
    ...
    <div style={styles.pageContainer}>
      <main style={styles.main}>
        ...
        <section style={styles.statsSection}>
          {[ { number: "20+", label: "Years Experience" }, { number: "2,500+", label: "Happy Clients" }, { number: "500 Cr", label: "Properties Sold" }, { number: "98%", label: "Client Satisfaction" } ].map((stat, index) => (
