...
const filteredProperties = properties.filter(property => {
  const matchesSearch = 
    safeToLower(property?.title).includes(safeToLower(searchTerm)) || 
    safeToLower(property?.address).includes(safeToLower(searchTerm)) || 
    safeToLower(property?.id).includes(safeToLower(searchTerm));
