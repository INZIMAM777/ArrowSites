  ...
  return (
    <header style={styles.header}>
      ...
      <nav style={styles.nav}>
        ...
        <NavLink to="0/about" style={getActiveStyle}>About</NavLink>
        <NavLink to="0/contact" style={getActiveStyle}>Contact</NavLink>
        <NavLink to="0/Cards" style={getActiveStyle}>Properties</NavLink>
        <NavLink to="0/AddPropr"><button style={styles.button}>Add property</button></NavLink>
      </nav>
    </header>
  );
};
