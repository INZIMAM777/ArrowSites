                  ...
                  <div className="dropdown-content">
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=apartment&transaction_type=buy" 
                        ...
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=villa&transaction_type=buy" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Villas
                        ...
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=plot&transaction_type=buy" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Plots
                    ...
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=office&transaction_type=buy" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Office Spaces
                        ...
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=retail&transaction_type=buy" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Retail
                        ...
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=industrial&transaction_type=buy" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Industrial
                    ...
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=luxury&transaction_type=buy" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Luxury
                        ...
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=affordable&transaction_type=buy" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Affordable
                        ...
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=upcoming&transaction_type=buy" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Upcoming
                  ...
                  <div className="dropdown-content">
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=flat&transaction_type=rent" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Flats
                        ...
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=house&transaction_type=rent" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Independent Houses
                        ...
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=pg&transaction_type=rent" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            PG & Co-living
                    ...
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=office&transaction_type=rent" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Office Spaces
                        ...
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=retail&transaction_type=rent" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Retail Spaces
                        ...
                        <li role="none">
                          <NavLink 
                            to="/Cards?propertyType=warehouse&transaction_type=rent" 
                            onClick={closeAllDropdowns} 
                            role="menuitem"
                          >
                            Warehouses
