                  ...
                  <div className="dropdown-content">
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("apartment", "buy")} 
                            role="menuitem"
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("villa", "buy")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Villas
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("plot", "buy")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Plots
                    ...
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("office", "buy")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Office Spaces
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("retail", "buy")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Retail
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("industrial", "buy")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Industrial
                    ...
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("luxury", "buy")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Luxury
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("affordable", "buy")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Affordable
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("upcoming", "buy")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Upcoming
