        ...
        <div className="header-container" style={headerStyles.headerContainer}>
          ...
          >
            <ul style={headerStyles.navList}>
              ...
              >
                ...
                >
                  ...
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" aria-hidden="true" style={{
                    ...
                    transform: activeDropdown === 'buyers' ? 'rotate(180deg)' : 'none'
                  }}>
                ...
                <div className="dropdown-menu" role="menu" style={{...headerStyles.dropdownMenu, ...(activeDropdown === 'buyers' ? headerStyles.dropdownMenuActive : {})}}>
                  {/* Mobile back button for dropdown */}
                  <div className="mobile-dropdown-header" style={headerStyles.mobileDropdownHeader}>
                    <button 
                      onClick={() => setActiveDropdown(null)} 
                      className="mobile-back-button"
                      style={headerStyles.mobileBackButton}
                    >
                    ...
                    <h3 style={{margin: 0, color: theme.text.primary}}>For Buyers</h3>
                  </div>
              ...
              {/* Tenants - Similar structure as Buyers */}
              <li 
              ...
              >
                ...
                >
                  ...
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" aria-hidden="true" style={{
                    ...headerStyles.dropdownIcon,
                    transform: activeDropdown === 'tenants' ? 'rotate(180deg)' : 'none'
                  }}>
                    <path d="M6 9L12 15L18 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </span>
                <div className="dropdown-menu" role="menu" style={{...headerStyles.dropdownMenu, ...(activeDropdown === 'tenants' ? headerStyles.dropdownMenuActive : {})}}>
                  ...
                  <div className="mobile-dropdown-header" style={headerStyles.mobileDropdownHeader}>
                    ...
                    <h3 style={{margin: 0, color: theme.text.primary}}>For Tenants</h3>
                  </div>
                  
                  <div className="dropdown-content" style={headerStyles.dropdownContent}>
                    {/* Same content structure as Buyers dropdown */}
                    <div className="dropdown-section" style={headerStyles.dropdownSection}>
                      <h4 style={headerStyles.dropdownSectionTitle}>Residential Properties</h4>
                      <ul role="group" style={headerStyles.dropdownList}>
                        <li role="none">
              ...
              {/* Owners - Similar structure as Buyers */}
              <li 
              ...
              >
                ...
                >
                  ...
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" aria-hidden="true" style={{
                    ...headerStyles.dropdownIcon,
                    transform: activeDropdown === 'owners' ? 'rotate(180deg)' : 'none'
                  }}>
                    <path d="M6 9L12 15L18 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </span>
                <div className="dropdown-menu" role="menu" style={{...headerStyles.dropdownMenu, ...(activeDropdown === 'owners' ? headerStyles.dropdownMenuActive : {})}}>
                  ...
                  <div className="mobile-dropdown-header" style={headerStyles.mobileDropdownHeader}>
                    ...
                    <h3 style={{margin: 0, color: theme.text.primary}}>For Owners</h3>
                  </div>
                  
                  <div className="dropdown-content" style={headerStyles.dropdownContent}>
                    {/* Same content structure as Owners dropdown */}
                    <div className="dropdown-section" style={headerStyles.dropdownSection}>
