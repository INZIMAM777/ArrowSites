                  ...
                  <div className="dropdown-content">
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("Residential Floors", "rent")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Floors
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("Residential Penthouse", "rent")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Penthouse
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("Residential Service Apartment", "rent")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Service Apartment
                    ...
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("Commercial Shop", "rent")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Shops
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("Commercial Office Space", "rent")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Office Space
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("Commercial Guest House", "rent")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Guest House
                    ...
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("Industrial Factory", "rent")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Factory
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("Industrial Land for Warehouse/Industry", "rent")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Warehouse/Industry
                    ...
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("Warehouse - Commercial", "rent")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            commercial warehouse
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("Warehouse - Agro", "rent")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Agro
                        ...
                        <li role="none">
                          <button 
                            onClick={() => handlePropertyTypeSelect("Warehouse - Transport", "rent")} 
                            role="menuitem"
                            className="dropdown-link"
                          >
                            Transport & Logistic
      ...
      <style>
        {`
          ...
          * {
          ...
          .btn:focus {
            box-shadow: 0 0 0 3px rgba(58, 123, 253, 0.2);
          }
