...
const colorTheme = {
  dark: {
    background: {
      primary: "#1e1b29",   // deep royal purple-black
      secondary: "#2a1f3d", // luxury purple dark
      tertiary: "#3b2565",  // muted violet
    },
    text: {
      primary: "#f5f3ff",   // off-white with lavender tint
      secondary: "#d8b4fe", // soft purple text
      accent: "#a78bfa",    // violet accent
    },
    border: {
      primary: "#4c1d95",   // strong purple border
      accent: "#8b5cf6",    // accent purple
    },
    button: {
      primary: "#7c3aed",       // bold purple button
      primaryHover: "#6d28d9",  // darker hover
      secondary: "#2a1f3d",     // dark secondary button
      secondaryHover: "#3b2565" // hover violet
    }
  },
  light: {
    background: {
    ...
    text: {
      primary: "#3b0764",   // deep royal purple
      secondary: "#5b21b6", // luxury violet
      accent: "#7e22ce",    // vibrant purple accent
    },
    border: {
      primary: "#d8b4fe",   // soft purple border
      accent: "#7e22ce",    // bold purple border
    },
    button: {
      primary: "#6d28d9",       // royal purple button
      primaryHover: "#5b21b6",  // darker hover
      secondary: "#ede9fe",     // light lavender button
      secondaryHover: "#d8b4fe" // hover lavender
    }
  }
};
