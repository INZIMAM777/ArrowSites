...
// Using emojis as icons instead of react-icons to avoid import issues
const Icons = {
  Home: "🏠",
  User: "👤",
  Users: "👥",
        ...
        <div className="header-container">
          <div className="logo">
            <NavLink to="/" onClick={closeAllDropdowns}>
              <span className="logo-icon">{Icons.Home}</span>
            ...
            <ul>
              ...
              >
                ...
                >
                  ...
                  For Buyers 
                  <span className="dropdown-chevron">{Icons.ChevronDown}</span>
                </span>
                <div className="dropdown-menu" role="menu">
                  <div className="dropdown-content">
                    <div className="dropdown-section">
                      <h4><span className="section-icon">{Icons.Home}</span> Residential Properties</h4>
                      <ul role="group">
                        <li role="none">
                          <button 
                          ...
                          >
                            <span className="link-icon">{Icons.Building}</span>
                            Flats
                          </button>
                        </li>
                        <li role="none">
                          <button 
                            ...
                            className="dropdown-link"
                          >
                            <span className="link-icon">{Icons.Layers}</span>
                            Floors
                          </button>
                        </li>
                        <li role="none">
                          <button 
                            ...
                            className="dropdown-link"
                          >
                            <span className="link-icon">{Icons.MapPin}</span>
                            Plots
                          </button>
                        </li>
                        <li role="none">
                        ...
                        <li role="none">
                          <button 
                            ...
                            className="dropdown-link"
                          >
                            <span className="link-icon">{Icons.Home}</span>
                            Villas
                          </button>
                        </li>
                        <li role="none">
                          <button 
                            ...
                            className="dropdown-link"
                          >
                            <span className="link-icon">{Icons.TrendingUp}</span>
                            Penthouse
                          </button>
                        </li>
                        <li role="none">
                          <button 
                            ...
                            className="dropdown-link"
                          >
                            <span className="link-icon">{Icons.Key}</span>
                            Service Apartment
                          </button>
                        </li>
                      </ul>
                    ...
                    <div className="dropdown-section">
                      <h4><span className="section-icon">{Icons.Briefcase}</span> Commercial Properties</h4>
                      <ul role="group">
                        <li role="none">
                          <button 
                            ...
                            className="dropdown-link"
                          >
                            <span className="link-icon">{Icons.DollarSign}</span>
                            Shops
                          </button>
                        </li>
                        <li role="none">
                          <button 
                            ...
                            className="dropdown-link"
                          >
                            <span className="link-icon">{Icons.Briefcase}</span>
                            Office Space
                          </button>
                        </li>
                        <li role="none">
                    ...
                    <div className="dropdown-section">
                      <h4><span className="section-icon">{Icons.Package}</span> Industrial</h4>
                      <ul role="group">
                        <li role="none">
                          <button 
                            ...
                            className="dropdown-link"
                          >
                            <span className="link-icon">{Icons.Package}</span>
                            Factory
                          </button>
                        </li>
                        <li role="none">
                        ...
                        <li role="none">
                          <button 
                            ...
                            className="dropdown-link"
                          >
                            <span className="link-icon">{Icons.Anchor}</span>
                            Warehouse/Industry
                          </button>
                        </li>
                      </ul>
                    ...
                    <div className="dropdown-section">
                      <h4><span className="section-icon">{Icons.Truck}</span> Warehouse</h4>
                      <ul role="group">
                        <li role="none">
                          <button 
                            ...
                            className="dropdown-link"
                          >
                            <span className="link-icon">{Icons.Truck}</span>
                        ...
                        <li role="none">
                          <button 
                            ...
                            className="dropdown-link"
                          >
                            <span className="link-icon">{Icons.Heart}</span>
                            Agro
                          </button>
                        </li>
                        <li role="none">
                    ...
                    <div className="dropdown-section">
                      <h4><span className="section-icon">{Icons.Home}</span> Farm House</h4>
                      <ul role="group">
                        <li role="none">
                          <button 
              ...
              >
                ...
                <div className="dropdown-menu" role="menu">
                  <div className="dropdown-content">
                    <div className="dropdown-section">
                      <h4><span className="section-icon">{Icons.TrendingUp}</span> List Properties</h4>
                      <ul role="group">
                        <li role="none"><NavLink to="/AddPropr" onClick={closeAllDropdowns} role="menuitem"><span className="link-icon">{Icons.Home}</span> Post Property</NavLink></li>
                        <li role="none"><NavLink to="/owner/pricing" onClick={closeAllDropdowns} role="menuitem"><span className="link-icon">{Icons.DollarSign}</span> Pricing Plans</NavLink></li>
                        <li role="none"><NavLink to="/owner/success" onClick={closeAllDropdowns} role="menuitem"><span className="link-icon">{Icons.TrendingUp}</span> Success Stories</NavLink></li>
                      </ul>
                    </div>
                    <div className="dropdown-section">
                      <h4><span className="section-icon">{Icons.Briefcase}</span> Manage Properties</h4>
                      <ul role="group">
                        <li role="none"><NavLink to="/owner/manage" onClick={closeAllDropdowns} role="menuitem"><span className="link-icon">{Icons.Briefcase}</span> Manage Listings</NavLink></li>
                        <li role="none"><NavLink to="/owner/performance" onClick={closeAllDropdowns} role="menuitem"><span className="link-icon">{Icons.TrendingUp}</span> Performance</NavLink></li>
                        <li role="none"><NavLink to="/owner/payments" onClick={closeAllDropdowns} role="menuitem"><span className="link-icon">{Icons.DollarSign}</span> Payments</NavLink></li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              {/* Static Links */}
              <li><NavLink to="/about" onClick={closeAllDropdowns}><span className="nav-icon">{Icons.Info}</span>About</NavLink></li>
              <li><NavLink to="/contact" onClick={closeAllDropdowns}><span className="nav-icon">{Icons.Phone}</span>Contact</NavLink></li>
              <li><NavLink to="/Cards" onClick={closeAllDropdowns}><span className="nav-icon">{Icons.Home}</span>Properties</NavLink></li>
              <li><NavLink to="/Admin" onClick={closeAllDropdowns}><span className="nav-icon">{Icons.Briefcase}</span>Admin</NavLink></li>
