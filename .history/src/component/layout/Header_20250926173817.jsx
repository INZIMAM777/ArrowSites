...
export const Header = ({ isDarkMode, setIsDarkMode }) => {
  ...
  light: {
    background: {
      primary: "#fff5f5",   // reddish white
      secondary: "#ffeaea", // softer reddish white
      tertiary: "#ffd6d6",  // deeper reddish background
    },
    text: {
      primary: "#7f1d1d",   // deep red text
      secondary: "#b91c1c", // lighter red
      accent: "#dc2626",    // accent red
    },
    border: {
      primary: "#fecaca",   // pale red border
      accent: "#dc2626",    // strong red border
    },
    button: {
      primary: "#ef4444",       // red button
      primaryHover: "#dc2626",  // darker hover red
      secondary: "#ffe4e4",     // light red secondary button
      secondaryHover: "#fecaca" // hover slightly darker
    }
  }
};
