                ...
                <div className="dropdown-menu" role="menu">
                  <div className="dropdown-content">
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none"><NavLink to="/buy/apartments" onClick={closeAllDropdowns} role="menuitem">Apartments</NavLink></li>
                        <li role="none"><NavLink to="/buy/villas" onClick={closeAllDropdowns} role="menuitem">Villas</NavLink></li>
                        <li role="none"><NavLink to="/buy/plots" onClick={closeAllDropdowns} role="menuitem">Plots</NavLink></li>
                      </ul>
                    </div>
                    <div className="dropdown-section">
                      <h4>Commercial Properties</h4>
                      <ul role="group">
                        <li role="none"><NavLink to="/buy/offices" onClick={closeAllDropdowns} role="menuitem">Office Spaces</NavLink></li>
                        <li role="none"><NavLink to="/buy/retail" onClick={closeAllDropdowns} role="menuitem">Retail</NavLink></li>
                        <li role="none"><NavLink to="/buy/industrial" onClick={closeAllDropdowns} role="menuitem">Industrial</NavLink></li>
                      </ul>
                    </div>
                    <div className="dropdown-section">
                      <h4>New Projects</h4>
                      <ul role="group">
                        <li role="none"><NavLink to="/buy/luxury" onClick={closeAllDropdowns} role="menuitem">Luxury</NavLink></li>
                        <li role="none"><NavLink to="/buy/affordable" onClick={closeAllDropdowns} role="menuitem">Affordable</NavLink></li>
                        <li role="none"><NavLink to="/buy/upcoming" onClick={closeAllDropdowns} role="menuitem">Upcoming</NavLink></li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="dropdown-menu" role="menu">
                  <div className="dropdown-content">
                    <div className="dropdown-section">
                      ...
                      <ul role="group">
                        <li role="none"><NavLink to="/rent/flats" onClick={closeAllDropdowns} role="menuitem">Flats</NavLink></li>
                        <li role="none"><NavLink to="/rent/houses" onClick={closeAllDropdowns} role="menuitem">Independent Houses</NavLink></li>
                        <li role="none"><NavLink to="/rent/pg" onClick={closeAllDropdowns} role="menuitem">PG & Co-living</NavLink></li>
                      </ul>
                    </div>
                    <div className="dropdown-section">
                      <h4>Commercial Rentals</h4>
                      <ul role="group">
                        <li role="none"><NavLink to="/rent/offices" onClick={closeAllDropdowns} role="menuitem">Office Spaces</NavLink></li>
                        <li role="none"><NavLink to="/rent/retail" onClick={closeAllDropdowns} role="menuitem">Retail Spaces</NavLink></li>
                        <li role="none"><NavLink to="/rent/warehouses" onClick={closeAllDropdowns} role="menuitem">Warehouses</NavLink></li>
                      </ul>
                    </div>
                  </div>
                </div>
