...
export const Header = ({ isDarkMode, setIsDarkMode }) => {
 ...
 const colorTheme = {
  ...
  light: {
    background: {
      primary: "#fef2f2",   // slightly off-white with red tint
      secondary: "#fca5a5", // medium red background
      tertiary: "#b91c1c",  // dark red / burgundy section
    },
    text: {
      primary: "#7f1d1d",   // dark red for readability
      secondary: "#991b1b", // deeper red shade
      accent: "#b91c1c",    // strong crimson accent
    },
    border: {
      primary: "#ef4444",   // vivid red border
      accent: "#991b1b",    // dark red border
    },
    button: {
      primary: "#b91c1c",       // strong dark red button
      primaryHover: "#7f1d1d",  // very deep red on hover
      secondary: "#fca5a5",     // lighter red secondary button
      secondaryHover: "#ef4444" // hover vivid red
    }
  }
};
