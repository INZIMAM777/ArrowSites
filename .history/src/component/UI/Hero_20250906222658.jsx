...
export const Hero = () => {
  ...
  }, []);"Commercial Shop">Commercial Shop</option>
                    <option value="Commercial Office Space">Commercial Office Space</option>
                    <option value="Commercial Guest House">Commercial Guest House</option>
                    <option value="Commercial Service Apartment"

  // Property type options
  const propertyTypes = [
    "Residential Flat", "Residential Floors", "Residential Plot",
    "Residential Villa", "Residential Penthouse","Residential Service Apartment", "Commercial Shop", "Commercial Office Space","Commercial Guest House","Commercial Service Apartment"
  ];
        ...
        <div style={heroStyles.tabsContainer}>
          <button 
            style={{
              ...
              ...(activeTab === "Residential Flat" ? heroStyles.activeTab : {})
            }}
            onClick={() => setActiveTab("Residential Flat")}
          >
            Residential
          </button>
          <button 
            style={{
              ...heroStyles.tabButton,
              ...(activeTab === "Commercial Shop" ? heroStyles.activeTab : {})
            }}
            onClick={() => setActiveTab("Commercial Shop")}
          >
            Commercial
          </button>
          <button 
            style={{
              ...heroStyles.tabButton,
              ...(activeTab === "Industrial Factory" ? heroStyles.activeTab : {})
            }}
            onClick={() => setActiveTab("Industrial Factory")}
          >
            Industrial
          </button>
          <button 
            style={{
              ...heroStyles.tabButton,
              ...(activeTab === "Warehouse - Commercial" ? heroStyles.activeTab : {})
            }}
            onClick={() => setActiveTab("Warehouse - Commercial")}
          >
            Warehouse
          </button>
          <button 
            style={{
              ...heroStyles.tabButton,
              ...(activeTab === "Farm House Land" ? heroStyles.activeTab : {})
            }}
            onClick={() => setActiveTab("Farm House Land")}
          >
            Farm House
          </button>
        </div>
