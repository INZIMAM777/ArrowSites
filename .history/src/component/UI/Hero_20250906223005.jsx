...
export const Hero = () => {
  ...
  "Warehouse – Commercial">Warehouse – Commercial</option>
                    ...
                    <option value="Warehouse Land / Industrial Land"
  ...
  const propertyTypes = [
    ...
    "Warehouse – Agro","Warehouse – Transport & Logistic","Warehouse Land / Industrial Land"
  ];
