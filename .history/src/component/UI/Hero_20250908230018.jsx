...
const colorTheme = {
  ...
  background: {
    ...
    overlayStrong: "linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,0.55))",
    overlayMedium: "linear-gradient(rgba(255,255,255,0.6), rgba(255,255,255,0.3))",
    overlayPattern: "repeating-linear-gradient(45deg, rgba(0,0,0,0.15), rgba(0,0,0,0.15) 10px, transparent 10px, transparent 20px)"
  },
  text: {
    primary: "#1e293b",   // dark slate for readability
    secondary: "rgb(21 37 61)", // medium gray-blue
    accent: "#3b82f6"     // blue accent stays
  },
  border: {
    primary: "#cbd5e1",
    accent: "#3b82f6",
