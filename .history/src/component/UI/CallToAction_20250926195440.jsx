...
const colorTheme = {
  dark: {
    background: {
      primary: "#1e40af", // blue background for dark mode
      secondary: "#1e3a8a",
      tertiary: "#1e40af",
    },
    text: {
  ...
  light: {
    background: {
      primary: "#0f172a", // use dark palette in light mode
      secondary: "#1e293b",
      tertiary: "#334155",
    },
    text: {
  ...
  const styles = {
    ctaSection: {
      ...
      backgroundImage: isDarkMode
        ? "linear-gradient(135deg, #3b82f6, #1e40af)" // blue gradient for dark
        : "linear-gradient(135deg, #0f172a, #1e293b)", // dark palette for light mode
      textAlign: "center",
      color: "white",
