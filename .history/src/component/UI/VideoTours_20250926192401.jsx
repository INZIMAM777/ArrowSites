...
export const VideoTours = ({ isDarkMode }) => {
  ...
  const handlePlay = (videoUrl) => setSelectedVideo(videoUrl);
  ...
  const styles = {
    ...
    playButton: {
      ...
      width: "60px",
      height: "60px",
      backgroundColor: isDarkMode ? "rgba(59, 130, 246, 0.9)" : "rgba(124, 58, 237, 0.9)", // purple for light mode
      borderRadius: "50%",
      display: "flex",
      alignItems: "center",
    ...
    viewPropertyBtn: {
      ...
      cursor: "pointer",
      border: "none",
      background: isDarkMode ? "linear-gradient(135deg, #3b82f6, #1d4ed8)" : "linear-gradient(135deg, #7c3aed, #6d28d9)",
      color: "#fff",
      transition: "all 0.3s ease",
      width: "100%",
    },
          ...
          {videoTours.map(video => (
            ...
            >
              <div style={styles.videoThumbnail} onClick={() => handlePlay(video.videoUrl)}>
                ...
                <div style={styles.playButton}><FaPlay /></div>
              ...
              <div style={styles.videoInfo}>
                ...
                <NavLink to='/Cards'>
                  <button 
                    ...
                    onMouseOver={(e) => {
                      e.target.style.background = isDarkMode ? "#2563eb" : "#6d28d9";
