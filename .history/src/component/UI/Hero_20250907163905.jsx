...
export const Hero = () => {
  ...
  // Get current theme based on isDarkMode state
  ...
  const heroStyles = {
    heroSection: {
      ...
      backgroundImage: `linear-gradient(rgba(131, 167, 244, 0.85), rgba(125, 156, 241, 0.95)), url(${backgroundImages[currentBackground]})`
    },
    heroContent: {
      position: "relative",
      zIndex: 2,
