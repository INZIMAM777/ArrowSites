...
const colorTheme = {
  dark: {
    ...
    text: {
      ...
      secondary: "#000000",
      accent: "#7c3aed", // purple accent remains for highlights
    },
    border: {
      primary: "#334155",
      accent: "#7c3aed",
          ...
          >
            ...
            <div style={styles.propertyDetails}>
              ...
              <div style={styles.propertyAddress}>
                <FaMapMarkerAlt style={{marginRight: "6px", color: gradientPrimary}} /> 
                {property.address || "Address not specified"}
              </div>

              <div style={styles.propertyFeatures}>
                <span style={styles.feature}><FaBed style={{marginRight: "4px", color: gradientPrimary}} /> {property.bedrooms}</span>
                <span style={styles.feature}><FaBath style={{marginRight: "4px", color: gradientPrimary}} /> {property.bathrooms}</span>
                <span style={styles.feature}><FaRulerCombined style={{marginRight: "4px", color: gradientPrimary}} /> {property.area_sqft}</span>
              </div>
