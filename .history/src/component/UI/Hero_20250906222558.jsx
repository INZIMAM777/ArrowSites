...
export const Hero = () => {
  ...
  "Residential Flat">Residential Flat</option>
                    ...
                    <option value="Residential Service Apartment

  // Property type options
  const propertyTypes = [
    "Residential Flat", "Residential Floors", "Residential Plot",
    "Residential Villa", "Residential Penthouse","Residential Service Apartment" "Commercial Shop", "Commercial Office Space"
  ];
