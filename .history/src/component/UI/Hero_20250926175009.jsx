...
const colorTheme = {
  dark: {
    background: {
      primary: "#1e0f3c",        // deep purple
      secondary: "#2c0f4f",      // darker purple for cards
      tertiary: "#3a0f63",       // tertiary sections
      overlay: "rgba(30, 15, 60, 0.7)", // purple overlay
    },
    text: {
      primary: "#e0d7f5",        // light lavender for contrast
      secondary: "#c0b0e0",      // muted purple text
      accent: "#a855f7",         // vibrant purple accent
    },
    border: {
      primary: "#3a0f63",        // purple border
      accent: "#a855f7",         // accent border
    },
    button: {
      primary: "#7c3aed",        // bright purple button
      primaryHover: "#6d28d9",   // darker purple hover
      secondary: "#2c0f4f",      // secondary button
      secondaryHover: "#3a0f63", // hover effect
    }
  },
  light: {
    background: {
      primary: "#f3e8ff",        // soft lavender
      secondary: "#e9d5ff",      // light purple section
      tertiary: "#d8b4fe",       // medium lavender
      overlayStrong: "linear-gradient(rgba(124,58,237,0.55), rgba(124,58,237,0.55))",
      overlayMedium: "linear-gradient(rgba(243,232,255,0.6), rgba(243,232,255,0.3))",
    ...
    text: {
      primary: "#4c1d95",        // deep purple text
      secondary: "#6b21a8",      // medium purple
      accent: "#a855f7",         // vibrant accent
    },
    border: {
    ...
    button: {
      primary: "#a855f7",        // main purple button
      primaryHover: "#9333ea",   // hover
      secondary: "#f3e8ff",      // light secondary button
      secondaryHover: "#e9d5ff", // hover
    }
  }
};
...
export const Hero = ({ isDarkMode }) => {
  ...
  const locations = [...new Set(properties
    .filter(p => p.address) // Filter out properties without address
  ...
  const heroStyles = {
    heroSection: {
      ...
      backgroundImage: `linear-gradient(${isDarkMode ? 'rgba(15, 23, 42, 0.85)' : 'hsla(0, 0%, 100%, 0.55)'}, ${isDarkMode ? 'rgba(15, 23, 42, 0.95)' : 'rgba(255, 255, 255, 0.55)'}), url(${backgroundImages[currentBackground]})`
    },
    heroContent: {
      position: "relative",
      zIndex: 2,
