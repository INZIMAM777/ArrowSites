...
import { FaBed, FaBath, FaRulerCombined, FaMapMarkerAlt, FaBuilding, FaCalendarAlt, FaArrowLeft, FaRupeeSign } from 'react-icons/fa';
...
export const CardsDetail = () => {
  ...
  if (!property) {
    return (
      <PropertyDetailError>
        <ErrorContainer>
          <ErrorMessage>No property found with ID: {dataId}</ErrorMessage>
          <BackLink to="/Cards">
            <FaArrowLeft /> Back to Listings
          </BackLink>
        </ErrorContainer>
      ...
      <PropertyDetailPage>
        <PropertyDetailContainer>
          ...
          <PropertyHeader>
            ...
            <PropertyLocation>
              <LocationIcon />
              <span>{property.address}, {city}, {state}, {country}</span>
            </PropertyLocation>
          </PropertyHeader>
          ...
          <div>
            ...
            <PropertyHighlights>
              <PriceSection>
                <PriceTag>
                  <RupeeIcon />
                  <span className="price-amount">{formatPrice(property.price, property.price_units)}</span>
            ...
            <PropertyDetails>
              ...
              <ContactSection>
                ...
                <ScheduleButton>Schedule Visit</ScheduleButton>
              </ContactSection>
            </PropertyDetails>
          </div>
        </PropertyDetailContainer>
      </PropertyDetailPage>import React from 'react';
...
const generateRandomSchedule = () => {
  ...
  // Get date for next occurrence of the random day
...
const sendWhatsAppMessage = (property, schedule) => {
  ...
  const message = `Hello, I'm interested in your property "${property.title}" (${property.address}). 
I would like to schedule a visit on ${schedule.timestamp}. 
