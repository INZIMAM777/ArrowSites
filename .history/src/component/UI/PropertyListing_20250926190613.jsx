...
export const PropertyListings = ({ title, isDarkMode }) => {
  ...
  const styles = {
    ...
    priceTag: {
      ...
      bottom: "12px",
      left: "12px",
      background: gradientPrimary, // dynamic gradient
      color: "white",
      padding: "6px 12px",
      borderRadius: "6px",
      fontWeight: 600,
          ...
          >
            ...
            <div style={styles.propertyDetails}>
              ...
              <div style={styles.propertyAddress}>
                <FaMapMarkerAlt style={{marginRight: "6px", color:  isDarkMode?'#3b82f6':theme.text.accent}} /> 
                {property.address || "Address not specified"}
              </div>

              <div style={styles.propertyFeatures}>
                <span style={styles.feature}><FaBed style={{marginRight: "4px", color: isDarkMode?'#3b82f6':theme.text.accent}} /> {property.bedrooms}</span>
                <span style={styles.feature}><FaBath style={{marginRight: "4px", color:  isDarkMode?'#3b82f6':theme.text.accent}} /> {property.bathrooms}</span>
                <span style={styles.feature}><FaRulerCombined style={{marginRight: "4px", color:  isDarkMode?'#3b82f6':theme.text.accent}} /> {property.area_sqft}</span>
              </div>
