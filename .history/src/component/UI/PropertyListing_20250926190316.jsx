...
export const PropertyListings = ({ title, isDarkMode }) => {
  ...
  <div style={styles.propertyAddress}>
    <FaMapMarkerAlt style={{ marginRight: "6px", color: isDarkMode ? "#60a5fa" : "#7c3aed" }} /> 
    {property.address || "Address not specified"}
  </div>

  <div style={styles.propertyFeatures}>
    <span style={{ ...styles.feature, color: isDarkMode ? "#60a5fa" : "#7c3aed" }}>
      <FaBed style={{ marginRight: "4px", color: isDarkMode ? "#60a5fa" : "#7c3aed" }} /> {property.bedrooms}
    </span>
    <span style={{ ...styles.feature, color: isDarkMode ? "#60a5fa" : "#7c3aed" }}>
      <FaBath style={{ marginRight: "4px", color: isDarkMode ? "#60a5fa" : "#7c3aed" }} /> {property.bathrooms}
    </span>
    <span style={{ ...styles.feature, color: isDarkMode ? "#60a5fa" : "#7c3aed" }}>
      <FaRulerCombined style={{ marginRight: "4px", color: isDarkMode ? "#60a5fa" : "#7c3aed" }} /> {property.area_sqft}
    </span>
  </div>
</div>
