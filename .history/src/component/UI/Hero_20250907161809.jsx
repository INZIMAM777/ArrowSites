...
export const Hero = () => {
  ...
  const { properties, isDarkMode } = useFirebase();
  ...
  // Color palettes for light and dark modes (same as header)
  const colorTheme = {
    dark: {
      background: {
        primary: "#0f172a",
  ...
  // Background images for rotation (different for light and dark modes)
  const backgroundImages = isDarkMode ? [
    ...
    "https://images.unsplash.com/photo-1600566753052-dc65bb1c72d7?auto=format&fit=crop&w=2070&q=80",
  ...
  const heroStyles = {
    heroSection: {
      ...
      backgroundImage: `linear-gradient(${isDarkMode ? 'rgba(15, 23, 42, 0.85)' : 'rgba(255, 255, 255, 0.9)'}, ${isDarkMode ? 'rgba(15, 23, 42, 0.95)' : 'rgba(255, 255, 255, 0.95)'}), url(${backgroundImages[currentBackground]})`
    },
    heroContent: {
      position: "relative",
      zIndex: 2,
    ...
    searchContainer: {
      ...
      borderRadius: "16px",
      boxShadow: isDarkMode ? "0 20px 40px rgba(0,0,0,0.2)" : "0 20px 40px rgba(0,0,0,0.1)",
      padding: "1.5rem",
      maxWidth: "800px",
      margin: "0 auto",
      transition: "all 0.3s ease",
    ...
    statValue: {
      ...
      fontWeight: 700,
      marginBottom: "0.3rem",
      textShadow: isDarkMode ? "0 2px 4px rgba(0,0,0,0.3)" : "0 2px 4px rgba(255,255,255,0.5)",
      background: "linear-gradient(90deg, #60a5fa, #3b82f6)",
      WebkitBackgroundClip: "text",
      WebkitTextFillColor: "transparent",
      backgroundClip: "text",
