...
export const CardsDetail = () => {
  const { properties, error } = useLoaderData();
    ...
    <div style={cardDetailStyles.container}>
      ...
      <div style={cardDetailStyles.body}>
        ...
        <div style={cardDetailStyles.info}>
          ...
          <p><span style={cardDetailStyles.label}>Bedrooms:</span> {properties.bedrooms || 'N/A'}</p>
          <p><span style={cardDetailStyles.label}>Bathrooms:</span> {properties.bathrooms || 'N/A'}</p>
          <p><span style={cardDetailStyles.label}>Area:</span> {properties.area_sqft?.toLocaleString('en-IN')} sq.ft.</p>
          <p><span style={cardDetailStyles.label}>Transaction Type:</span> {properties.transaction_type}</p>
          <p><span style={cardDetailStyles.label}>Furnishing:</span> {properties.furnishing}</p>
        </div>
      </div>
    </div>
  );
