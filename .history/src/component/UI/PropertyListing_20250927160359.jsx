...
export const PropertyListings = ({ title, isDarkMode }) => {
  ...
  const gradientPrimary = isDarkMode
    ? "linear-gradient(135deg, #60a5fa, #3b82f6)" // blue for dark
    : "linear-gradient(135deg, #7c3aed, #6d28d9)"; // purple for light
  ...
  const styles = {
    ...
    propertyTitle: {
      ...
      fontWeight: 600,
      marginBottom: "0.8rem",
      color: isDarkMode ? theme.text.primary : "#000000", // black in light mode
      display: "-webkit-box",
      WebkitLineClamp: 1,
    ...
    loading: {
      ...
      padding: "2rem",
      fontSize: "1rem",
      color: isDarkMode ? theme.text.secondary : "#000000",
    },
  };
          ...
          >
            ...
            <div style={styles.propertyDetails}>
              ...
              <div style={styles.propertyAddress}>
                <FaMapMarkerAlt style={{marginRight: "6px", color: isDarkMode?'#3b82f6':'#000'}} /> 
                {property.address || "Address not specified"}
              </div>

              <div style={styles.propertyFeatures}>
                <span style={styles.feature}><FaBed style={{marginRight: "4px", color: isDarkMode?'#3b82f6':'#000'}} /> {property.bedrooms}</span>
                <span style={styles.feature}><FaBath style={{marginRight: "4px", color: isDarkMode?'#3b82f6':'#000'}} /> {property.bathrooms}</span>
                <span style={styles.feature}><FaRulerCombined style={{marginRight: "4px", color: isDarkMode?'#3b82f6':'#000'}} /> {property.area_sqft}</span>
              </div>
