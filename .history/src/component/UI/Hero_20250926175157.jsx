...
const colorTheme = {
  dark: {
    background: {
      primary: "#2563eb",       // main background
      secondary: "#2563eb",     // cards / sections
      tertiary: "#2563eb",      // tertiary sections
      overlay: "rgba(37, 99, 235, 0.7)" // overlay
    },
    text: {
      primary: "#2563eb",       // main text
      secondary: "#2563eb",     // muted text
      accent: "#2563eb"         // accent
    },
    border: {
      primary: "#2563eb",       // border
  ...
  light: {
    background: {
      ...
      secondary: "#2563eb",
      tertiary: "#2563eb",
      overlayStrong: "linear-gradient(rgba(37,99,235,0.55), rgba(37,99,235,0.55))",
      overlayMedium: "linear-gradient(rgba(37,99,235,0.6), rgba(37,99,235,0.3))",
      overlayPattern: "repeating-linear-gradient(45deg, rgba(37,99,235,0.15), rgba(37,99,235,0.15) 10px, transparent 10px, transparent 20px)"
    },
    text: {
      primary: "#2563eb",
      secondary: "#2563eb",
