...
export const CardsDetail = () => {
  ...
  if (!property) {
    return (
      <div style={cardDetailStyles.container}>
        <h2 style={cardDetailStyles.error}>No property found with ID: {dataId}</h2>
        <Link to="/Cards" style={cardDetailStyles.backLink}>← Back to Listings</Link>
      </div>
    );
  }
    ...
    <div style={cardDetailStyles.container}>
      ...
      <div style={cardDetailStyles.body}>
        ...
        <div style={cardDetailStyles.info}>
          ...
          {property.bedrooms && <p><span style={cardDetailStyles.label}>Bedrooms:</span> {property.bedrooms}</p>}
          {property.bathrooms && <p><span style={cardDetailStyles.label}>Bathrooms:</span> {property.bathrooms}</p>}
          ...
          {property.builder && <p><span style={cardDetailStyles.label}>Builder:</span> {property.builder}</p>}
          {property.year_built && <p><span style={cardDetailStyles.label}>Year Built:</span> {property.year_built}</p>}
