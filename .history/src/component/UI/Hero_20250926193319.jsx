...
export const Hero = ({ isDarkMode }) => {
  ...
  const getStyles = () => {
    return {
      ...
      primaryButton: {
        background: 'linear-gradient(135deg, #7c3aed, #6d28d9)', // rich purple gradient
        color: '#fff',
        boxShadow: '0 4px 12px rgba(124, 58, 237, 0.35)',       // purple shadow for luxury effect
      }
      ,
      secondaryButton: {
      ...
      toggleButton: {
        ...
        alignItems: 'center',
        gap: '10px',
        border: isDarkMode ? 'none' : `1px solid ${theme.border.accent}`,
        backgroundColor: theme.background.primary,
  ...
  const heroStyles = {
    heroSection: {
      ...
      justifyContent: "center",
      overflow: "hidden",
      color: isDarkMode?'':'rgba(15, 23, 41, 1)',
      fontFamily: "'Montserrat', sans-serif",
