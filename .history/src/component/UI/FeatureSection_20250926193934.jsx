...
const colorTheme = {
  ...
  light: {
    ...
    text: {
      primary: "#1e293b",
      secondary: "#475569",
      accent: "#7c3aed", // purple accent for luxury feel
    },
    border: {
      primary: "#e2e8f0",
      accent: "#7c3aed",
          ...
          <div
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = isDarkMode
                ...
                : "0 12px 30px rgba(124,58,237,0.25)"; // purple glow in light mode
              e.currentTarget.style.borderColor = !isDarkMode ? "#7c3aed" : theme.border.primary;
            }}
            onMouseLeave={(e) => {
