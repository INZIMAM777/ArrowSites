...
@media (max-width: 485px) {
  .property-card {
    max-width: 100%;      /* full width inside 2-col grid */
    margin: 0.5rem auto;
    border-radius: 10px;
  }

  .property-image { 
    height: 160px;        /* shorter images */
  }
  ...
  .feature-value { font-size: 0.75rem; }
  .feature-value span { font-size: 0.8rem; }
  .feature-label { font-size: 0.6rem; }
