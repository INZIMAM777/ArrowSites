...
export const Hero = ({ isDarkMode }) => {
  ...
  const heroStyles = {
    heroSection: {
      ...
      backgroundImage: `linear-gradient(${isDarkMode ? 'rgba(15, 23, 42, 0.85)' : 'hsla(0, 0%, 100%, 0.0)'}, ${isDarkMode ? 'rgba(15, 23, 42, 0.95)' : 'rgba(255, 255, 255, 0.05)'}), url(${backgroundImages[currentBackground]})`
    },
    heroContent: {
      position: "relative",
      zIndex: 2,
