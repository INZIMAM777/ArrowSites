...
export const Hero = ({ isDarkMode }) => {
  ...
  primaryButtonHover: {
    background: 'linear-gradient(135deg, #7c3aed, #6d28d9)', // purple gradient
    transform: 'translateY(-2px)',
    boxShadow: '0 6px 16px rgba(124, 58, 237, 0.35)'      // purple shadow
  },
  secondaryButtonHover: {
    backgroundColor: theme.background.tertiary,  // keeps tertiary background
    color: theme.text.primary,
    borderColor: theme.border.accent             // purple accent border
  },
  tertiaryButtonHover: {
    backgroundColor: `${theme.text.accent}15`   // translucent purple
  },
  clearButtonHover: {
    color: theme.text.primary,
