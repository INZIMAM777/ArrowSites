...
export const DetailCard = () => {
    ...
    firebase.getLists()
      .then(snapshot => {
        const properties = snapshot.docs.map(doc => ({
          id: doc.id,
          ...doc.data(),
          amenities: doc.data().amenities || [] // Ensure amenities is always an array
        }));
  ...
  // Show error if property is still null/undefined
  if (!property) {
    return (
      <PropertyDetailError>
        <ErrorContainer>
          <ErrorMessage>Property not found or failed to load.</ErrorMessage>
          <BackLink to="/Cards">
            <FaArrowLeft /> Back to Listings
          </BackLink>
        </ErrorContainer>
            ...
            <div>
              ...
              <DetailsGrid>
                <DetailItem>
                  ...
                  <DetailValue>{property.type || 'N/A'}</DetailValue>
                </DetailItem>
                <DetailItem>
