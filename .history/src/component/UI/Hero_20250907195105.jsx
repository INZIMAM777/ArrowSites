...
export const Hero = ({ isDarkMode }) => {
  ...
  const heroStyles = {
    heroSection: {
      ...
      fontFamily: "'Montserrat', sans-serif", // Applied Montserrat for body
    ...
    heroTitle: {
      ...
      fontFamily: "'Gilroy', 'Montserrat', sans-serif", // Applied Gilroy for headings
    },
    heroSubtitle: {
    ...
    tabButton: {
      ...
      borderRadius: "25px",
      border: "none",
      background: isDarkMode ? "rgba(255, 255, 255, 0.1)" : "rgba(0,0,0,0.05)", // Fixed the color value
      color: theme.text.primary,
      fontSize: "0.9rem",
      fontWeight: 500,
      cursor: "pointer",
      ...
      fontFamily: "'Montserrat', sans-serif", // Applied Montserrat for UI elements
    },
    activeTab: {
    ...
    searchInput: {
      ...
      color: theme.text.primary,
      fontFamily: "'Montserrat', sans-serif", // Applied Montserrat for input text
    },
    searchInputFocused: {
    ...
    suggestionItem: {
      ...
      color: theme.text.primary,
      backgroundColor: theme.background.primary,
      fontFamily: "'Montserrat', sans-serif", // Applied Montserrat for suggestions
    },
    filterToggle: {
      padding: "0.5rem 1rem",
    ...
    filterSelect: {
      ...
      color: theme.text.primary,
      outline: "none",
      fontFamily: "'Montserrat', sans-serif", // Applied Montserrat for select elements
    },
    searchButton: {
      ...
      fontFamily: "'Montserrat', sans-serif", // Applied Montserrat for button text
    },
    statsContainer: {
      display: "flex",
    ...
    statValue: {
      ...
      backgroundClip: "text",
      fontFamily: "'Gilroy', 'Montserrat', sans-serif", // Applied Gilroy for stats values
    },
    statLabel: {
      fontSize: "0.85rem",
      opacity: 0.9,
      fontWeight: 300,
      color: theme.text.secondary,
      fontFamily: "'Montserrat', sans-serif", // Applied Montserrat for stats labels
    },
    scrollIndicator: {
      position: "absolute",
      bottom: "1rem",
    ...
    scrollText: {
      marginBottom: "0.4rem",
      fontSize: "0.8rem",
      fontFamily: "'Montserrat', sans-serif", // Applied Montserrat for scroll text
    },
    scrollArrow: {
      width: "16px",
      height: "16px",
    ...
    <section style={heroStyles.heroSection}>
      <div style={heroStyles.heroContent}>
        ...
        <div style={heroStyles.tabsContainer}>
          {["Residential Flat", "Commercial shop", "Industrial plot", "Warehouse - Agro", "Farm House L"].map((tab) => (
            <button 
              key={tab}
              style={{
