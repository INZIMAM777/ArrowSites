...
const BookifyContext = createContext(null);

export const useFirebase = () => useContext(BookifyContext)
...
export const BookifyProvider = (props) => {
    ...
    return (<>
        <BookifyContext.Provider value={{ signUpEp, signInEp, signGoogle,removeSign,handleListing,getLists,isLoggedIn }}>
            {props.children}
