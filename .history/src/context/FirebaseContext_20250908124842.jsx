...
export const ArrowProvider = (props) => {
  ...
  const getAdmin=async()=>{
    const adminEmail= getDocs(collection(firestore,'admin')); 
   (await adminEmail).forEach((doc)=>console.log(doc.data()))
     return await adminEmail;
  }
...
const updateProperty = async (id, data) => {
  ...
  return (<>
    <ArrowContext.Provider value={{
      signUpEp, signInEp, signGoogle, removeSign, getLists, handleListing, deleteProperty, updateProperty,isLoggedIn, properties, loading,
      error,firestore,presentId
    }}>
      {props.children}
